...
#ifndef _PILOT_ESPI_OOB_H_
#define _PILOT_ESPI_OOB_H_

#define PILOT_ESPIOOB_DRIVER_NAME       "pilot_espioob"
...
#define PILOT_ESPIOOB_CHANNEL_NUM       1
