...
const struct DEVICE_INFO device_list[]={
  ...
  {.idcode =LATTICE_CPLD_LCMXO3_6900C_IDCODE,	.name=LATTICE_CPLD_LCMXO3_6900C_DEVNAME, .func = device_MACHOX2, .support_loop_func = 1},
  #endif
  #if 0
  {.idcode =LATTICE_CPLD_LCMXO640C_IDCODE, .name=LATTICE_CPLD_LCMXO640C_DEVNAME,.func = device_MACHOX, .support_loop_func = 0},
  #endif
...
void read_code_size_data (unsigned int *JTAG_data_buffer,unsigned int TDI)
{
	...
	#define PILOT_JTAG_BUFFER_SIZE 0x180000
	memset (JTAG_data_buffer, 0, PILOT_JTAG_BUFFER_SIZE);
...
uint32_t load_device_info(unsigned long id_code){
  ...
  const JTAG_DEVICE_INFO MachXO_information[]=
  {
	...
	{ //LATTICE_CPLD_LCMXO3_6900C_DEVNAME: 
      .Device_Name    =               LATTICE_CPLD_LCMXO3_6900C_DEVNAME,
      .Device_ID      =               LATTICE_CPLD_LCMXO3_6900C_IDCODE,
      .Device_Column_Length   =       LATTICE_COLS_LCMXO3_6900C_LENGTH,
      .Device_Row_Length      =       LATTICE_ROWS_LCMXO3_6900C_LENGTH,
      .Device_All_Bits_Length =       LATTICE_BITS_LCMXO3_6900C_LENGTH,
      .Device_Bscan_Length    =       LATTICE_BSCAN_LCMXO3_6900C_LENGTH,
      .Device_Fuses_Length    =       LATTICE_FUSES_LCMXO3_6900C_LENGTH
    },
    #endif
    #if 0
