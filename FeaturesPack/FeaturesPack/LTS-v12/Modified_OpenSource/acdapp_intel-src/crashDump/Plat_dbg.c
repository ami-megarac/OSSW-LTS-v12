...
int main (int argc, char **argv)
{
	...
	strncpy(crashdump_dir, CRASHDUMP_DIRECTORY, strlen(CRASHDUMP_DIRECTORY));
	strncpy(crashdump_json_dir, CRASHDUMP_JSON_DIRECTORY, strlen(CRASHDUMP_JSON_DIRECTORY));
