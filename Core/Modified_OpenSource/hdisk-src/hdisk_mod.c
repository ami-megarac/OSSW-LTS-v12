...
FillDevInfo (IUSB_DEVICE_INFO* iUSBDevInfo)
{
	...
	iUSBDevInfo->DevNo      = (uint8)hdisk_device_driver.devnum; /* Fortify [Type Mismatch: Signed to Unsigned]:: False Positive *//* Reason for False Positive - Casting reture value as unsigned int8 parameter to fit return value. */
    iUSBDevInfo->IfNum      = 0; 
