...
#if defined(CONFIG_SPX_FEATURE_I2C0_DMA_MODE) || defined(CONFIG_SPX_FEATURE_I2C1_DMA_MODE) || defined(CONFIG_SPX_FEATURE_I2C2_DMA_MODE) || \
	defined(CONFIG_SPX_FEATURE_I2C3_DMA_MODE) || defined(CONFIG_SPX_FEATURE_I2C4_DMA_MODE) || defined(CONFIG_SPX_FEATURE_I2C5_DMA_MODE) || \
	defined(CONFIG_SPX_FEATURE_I2C6_DMA_MODE) || defined(CONFIG_SPX_FEATURE_I2C7_DMA_MODE) || defined(CONFIG_SPX_FEATURE_I2C8_DMA_MODE) || \
	defined(CONFIG_SPX_FEATURE_I2C9_DMA_MODE) || defined(CONFIG_SPX_FEATURE_I2C10_DMA_MODE) || defined(CONFIG_SPX_FEATURE_I2C11_DMA_MODE) || \
	defined(CONFIG_SPX_FEATURE_I2C12_DMA_MODE) || defined(CONFIG_SPX_FEATURE_I2C13_DMA_MODE) || defined(CONFIG_SPX_FEATURE_I2C14_DMA_MODE) || \
	defined(CONFIG_SPX_FEATURE_I2C15_DMA_MODE) || defined(CONFIG_SPX_FEATURE_I2C16_DMA_MODE) || defined(CONFIG_SPX_FEATURE_I2C17_DMA_MODE) || \
	defined(CONFIG_SPX_FEATURE_I2C18_DMA_MODE) || defined(CONFIG_SPX_FEATURE_I2C19_DMA_MODE) || defined(CONFIG_SPX_FEATURE_I2C20_DMA_MODE) || \
	defined(CONFIG_SPX_FEATURE_I2C21_DMA_MODE) || defined(CONFIG_SPX_FEATURE_I2C22_DMA_MODE) || defined(CONFIG_SPX_FEATURE_I2C23_DMA_MODE) || \
	defined(CONFIG_SPX_FEATURE_I2C24_DMA_MODE) || defined(CONFIG_SPX_FEATURE_I2C25_DMA_MODE) || defined(CONFIG_SPX_FEATURE_I2C26_DMA_MODE) || \
	defined(CONFIG_SPX_FEATURE_I2C27_DMA_MODE) ||defined(CONFIG_SPX_FEATURE_I2C28_DMA_MODE) || defined(CONFIG_SPX_FEATURE_I2C29_DMA_MODE)
	/* Enable SRAM Buffer */
