--- u-boot-2013.07/arch/arm/cpu/pilotcommon/pilotmii.c	1970-01-01 08:00:00.000000000 +0800
+++ mywork/arch/arm/cpu/pilotcommon/pilotmii.c	2020-03-20 15:54:12.626764363 +0800
@@ -0,0 +1,428 @@
+#include <common.h>
+#if (CONFIG_CMD_NET)
