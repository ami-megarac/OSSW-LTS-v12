 ...
 * platform-specific initialization module for JADE
 *
 ****************************************************************/
...
int __init init_module(void)
{
	 ...
	 * Enable I2C pin configuration for I2C-[3:9] and I2C-11
	 */
	...
	reg |= AST_SCU_MULTI_PIN_MAC2_MD | AST_SCU_MULTI_PIN_SD2 |
		...
		AST_SCU_MULTI_PIN_I2C9 | AST_SCU_MULTI_PIN_I2C11;
	 ...
	 */
	/*
	 * Force BMC UART3 to 2-pin mode to be compatible with ATF setting.
	 * ATF is using UART 2-pin mode
	 */
    reg &= ~0x3F3F0000;
	 ...
	 */
	/*
	 * Force BMC UART2 to 2-pin mode to be compatible with SCP setting.
	 * SCP is using UART 2-pin mode
	 */
	reg &= ~0x3F3F0000;
...
MODULE_DESCRIPTION("platform-specific initialization module for JADE");
MODULE_LICENSE("GPL");
